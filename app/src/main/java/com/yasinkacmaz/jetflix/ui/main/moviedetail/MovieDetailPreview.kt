...
private fun MovieDetailPreview() {
    ...
    val navigator = Navigator<Screen>(Screen.FetchGenres, LifecycleOwnerAmbient.current, OnBackPressedDispatcher {})
    Providers(
        DominantColorAmbient provides mutableStateOf(Color.randomColor()),
        NavigatorAmbient provides navigator
    ) {
        val images = listOf(
