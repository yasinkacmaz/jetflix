...
class FilterBottomSheetTest {
    ...
    @Test
    fun `Should show sort order as selected`(): Unit = with(composeTestRule) {
    ...
    @Test
    fun `Should show sort by as selected`(): Unit = with(composeTestRule) {
    ...
    @Test
    fun `Should show genres`(): Unit = with(composeTestRule) {
    ...
    @Test
    fun `Should show selected genres`(): Unit = with(composeTestRule) {
        val genreNames = listOf("Action", "Drama", "Animation", "Comedy")
        val uiModels = genreNames.map { GenreUiModel(genre = Genre(id = -1, name = it)) }
    ...
    @Test
    fun `Should show include adult`(): Unit = with(composeTestRule) {
